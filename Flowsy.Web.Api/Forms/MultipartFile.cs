...
{
    public MultipartFile(string key, string fileName, Stream stream, FileContentDescriptor contentDescriptor)
    {
        Key = key;
        FileName = fileName;
    ...
    /// </summary>
    public FileContentDescriptor ContentDescriptor { get; }
